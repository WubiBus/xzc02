 ...
 * {@link HeaderFooterGridView#addHeaderView(View, Object, boolean)} See
...
public class HeaderFooterGridView extends GridView {
	...
	private OnGridViewScrollListener listener;

	public void setOnGridViewScrollListener(OnGridViewScrollListener listener) {
	...
	public interface OnGridViewScrollListener extends CustomScrollListener {
	}
