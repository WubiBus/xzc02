 ...
 * @author guohaibig
 */
@ContentView(R.layout.activity_user_paragraph)
public class UserParagraphActivity extends BaseFragmentActivity implements OnTouchMoveListener, IRefreshingAnimationView {
	...
	private void init() {
		...
		tvNickname.setText("“"+nickname+"“"+"的作品");
		blur = new Blur(this);
		...
		adapter = new ContrastListAdapter(list, getLayoutInflater(),new OnContrastListItemClickListener());
